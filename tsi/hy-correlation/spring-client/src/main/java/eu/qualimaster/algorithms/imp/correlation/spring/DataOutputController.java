...
/**
 * Class template to handle outputs of quote and depth data. To write in the appropriate output
 * file
 */
public class DataOutputController {
   ...
   */
  public static void saveQuoteData(String line)
      throws Exception {
    FileWriter fw = null;
    PrintWriter pw = null;
    try {
      ...
      //		+ "." + fileFormat, true);
      fw = new FileWriter(quoteFolderName + File.separator + "data." + fileFormat, true);
